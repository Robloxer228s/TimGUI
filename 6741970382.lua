_G.AGF("Zombie lab") 
local virus = _G.ABF("virus", "Get virus", "Zombie lab", 1) 
local cure = _G.ABF("cure", "Get cure", "Zombie lab", 2) 
local dh = _G.ABF("dh", "Delete human only", "Zombie lab", 3) 
local ds = _G.ABF("ds", "Delete safe virus zone", "Zombie lab", 4)
local kaz = _G.ABF("kaz", "Kill All Zombies", "Zombie lab", 5)
local ZN = _G.ATBF("ZN", "Zombie:", "Zombie lab", 6) 
local kz = _G.ABF("kz", "Kill Zombie", "Zombie lab", 7)
